...
class Decoder_fuse(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, mask):
        ...
        return pred, (prm_pred1, self.up2(prm_pred2), self.up4(prm_pred3), self.up8(prm_pred4)), logits
...
class Model(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        fuse_pred, prm_preds, fuse_logits = self.decoder_fuse(x1, x2, x3, x4, mask)




        if self.is_training:
            flair_pred, flair_logits = self.decoder_sep(flair_x1, flair_x2, flair_x3, flair_x4)
            t1ce_pred, t1ce_logits = self.decoder_sep(t1ce_x1, t1ce_x2, t1ce_x3, t1ce_x4)
            t1_pred, t1_logits = self.decoder_sep(t1_x1, t1_x2, t1_x3, t1_x4)
            t2_pred, t2_logits = self.decoder_sep(t2_x1, t2_x2, t2_x3, t2_x4)

            return fuse_pred, (flair_pred, t1ce_pred, t1_pred, t2_pred), prm_preds, fuse_logits, (flair_logits, t1ce_logits, t1_logits, t2_logits)
        return fuse_pred
